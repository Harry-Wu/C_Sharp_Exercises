...
//****************************** Module Header ******************************\
//Now can setup the initialize the serial port
//*****************************************************************************/
...
namespace Serialport_communication
{
    class Program
    {
        ...
        {
            SerialPort myserialPort = new SerialPort(str);
            Console.WriteLine("Please set the BaudRate:");
            myserialPort.BaudRate =Convert.ToInt32(Console.ReadLine());
            Console.WriteLine("Please set the Parity:");
            myserialPort.Parity = (Parity) Convert.ToInt32(Console.ReadLine());
            Console.WriteLine("Please set the DataBits:");
            myserialPort.DataBits = Convert.ToInt32(Console.ReadLine());
            Console.WriteLine("Please set the StopBits:");
            myserialPort.StopBits = (StopBits) Convert.ToInt32(Console.ReadLine());
